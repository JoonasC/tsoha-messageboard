...
CREATE TABLE message_replies (message_id INTEGER REFERENCES messages(id) ON DELETE CASCADE, replied_message_id INTEGER, UNIQUE (message_id, replied_message_id));
